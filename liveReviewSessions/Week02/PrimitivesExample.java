...
long distanceMore = 3_000_000_000L; // we have to put L to define the variabl
long distanceShorter = 1_000_000_000; // If it does not pass the limit than we dont have to give
...
// you might need to swap or re-assign some different range of values.
        ...
        num2 = num1; // I am assigning num1 value to num// 2
        //implicit casting, Widening, done by the complier
        ...
        System.out.println("Explicit Casting of loating points");
